...
namespace Bubo\Translation\LocaleResolver;
 ...
 */
class LangParamResolver extends Nette\Object implements Kdyby\Translation\IUserLocaleResolver
{
	...
	public function onRequest(Application $sender, Request $request)
	{
		...
		if ($request->getMethod() === Request::FORWARD && empty($params['lang'])) {
			return;
		}
	...
	public function resolve(Kdyby\Translation\Translator $translator)
	{
		...
		return !empty($params['lang']) ? $params['lang'] : NULL;
	}
